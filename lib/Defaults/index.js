...
exports.version = [2, 3000, 1036696425];
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    // Default AI behavior for sendMessage when content.ai is omitted (messages-send.js sets `biz_bot=1` when this resolves true).
