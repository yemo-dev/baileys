...
const makeMessagesSocket = (config) => {
    ...
    const sendGroupStatus = async (groupIdsOrContent = [], contentOrGroups = {}, opts = {}) => {
        ...
        const normalizeStatusGroupJid = (value) => {
        ...
        const groupJids = groupIds
            .map(normalizeStatusGroupJid)
            .filter(jid => (0, WABinary_1.isJidGroup)(jid));
        const nonGroupJids = groupIds.filter(jid => !(0, WABinary_1.isJidGroup)(normalizeStatusGroupJid(jid)));
