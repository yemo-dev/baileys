...
const makeMessagesSocket = (config) => {
    ...
    const sendGroupStatus = async (groupIdsOrContent = [], contentOrGroups = {}, opts = {}) => {
        ...
        const normalizeGroupStatusGroupJid = (value) => {
            ...
            return (0, WABinary_1.jidNormalizedUser)(trimmed);
        };
        ...
        const groupJids = groupIds
            .map(normalizeGroupStatusGroupJid)
            .filter(jid => (0, WABinary_1.isJidGroup)(jid));
        const nonGroupJids = groupIds.filter(jid => !(0, WABinary_1.isJidGroup)(normalizeGroupStatusGroupJid(jid)));
