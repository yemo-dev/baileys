...
// Interactive/carousel payloads can carry protobuf message keys (e.g. imageMessage).
...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const uploadData = {
        ...message,
        media: message[mediaInputKey]
    };
    delete uploadData[mediaInputKey];
