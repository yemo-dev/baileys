...
const hasMediaPayload = (message) => Defaults_1.MEDIA_KEYS.some(key => key in message)
    || MEDIA_MESSAGE_TYPE_ALIAS_KEYS.some(key => key in message);
