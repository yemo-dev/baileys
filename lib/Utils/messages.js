...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        else if (requestPayment === null || requestPayment === void 0 ? void 0 : requestPayment.noteMessage) {
        ...
        m.requestPaymentMessage = Types_1.WAProto.Message.RequestPaymentMessage.fromObject({
            ...
            amount1000: requestPayment.amount || requestPayment.amount1000,
            currencyCodeIso4217: requestPayment.currency || requestPayment.currencyCodeIso4217,
            requestFrom: requestPayment.from || requestPayment.requestFrom,
            noteMessage: { ...notes },
