...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        const sticker = (requestPayment === null || requestPayment === void 0 ? void 0 : requestPayment.sticker) ?
            await (0, exports.prepareWAMessageMedia)({ sticker: requestPayment === null || requestPayment === void 0 ? void 0 : requestPayment.sticker, ...options }, options)
            : null;
        let notes = {};
        if (requestPayment === null || requestPayment === void 0 ? void 0 : requestPayment.sticker) {
            ...
            const hasAllowedKey = noteKeys.some(key => allowedNoteMessageKeys.includes(key));
            const hasOnlyAllowedKeys = noteKeys.every(key => allowedNoteMessageKeys.includes(key));
            if (!hasAllowedKey || !hasOnlyAllowedKeys) {
        ...
        if (typeof amount1000 !== 'number' || !Number.isFinite(amount1000) || amount1000 <= 0) {
            throw new boom_1.Boom('Invalid requestPayment fields: amount/amount1000 must be a positive number', { statusCode: 400 });
        }
        m.requestPaymentMessage = Types_1.WAProto.Message.RequestPaymentMessage.fromObject({
            ...
            requestFrom,
            noteMessage: { ...notes },
            background: (_c = requestPayment.background) !== null && _c !== void 0 ? _c : null,
        });
    }
